...
def upload_hdfs(outfile):
	try :
		destination_dir = '/team40/'  + 'user_search_data/'+ time.strftime('%Y-%m-%d_%H-%M',time.localtime()) + '_Part3_'+ outfile
		hdfs = InsecureClient('http://115.146.86.32:50070', user='qilongz')
...
if __name__ == '__main__':
	...
	part3_chunks  = [part3[i:i+100] for i in range(0, len(part3), 500)]	
	for i in  part3_chunks:
		get_all_tweets(i,config.machine3)
		upload_hdfs(outfile)
		print('YES ! loaded')
